...
template <>
bool BetaScope_Ext::BuildBranch<double>(std::string branchName ){ return BetaScope::BuildOutBranch<double>(branchName); }

template <>
bool BetaScope_Ext::BuildBranch<int>(std::string branchName ){ return BetaScope::BuildOutBranch<int>(branchName); }

template <>
bool BetaScope_Ext::BuildBranch<std::vector<double>>(std::string branchName ){ return BetaScope::BuildOutBranch<std::vector<double>>(branchName); }

template <>
bool BetaScope_Ext::BuildBranch<std::vector<int>>(std::string branchName ){ return BetaScope::BuildOutBranch<std::vector<int>>(branchName); }
...
{
  if( typeName.compare("TTreeReaderArray<double>") ==0 ){ return BetaScope::SetInBranch<TTreeReaderArray,double>( branchName.c_str(), key.c_str()); }
  else if( typeName.compare("TTreeReaderArray<int>") ==0 ){ return BetaScope::SetInBranch<TTreeReaderArray,int>( branchName.c_str(), key.c_str()); }
  else if( typeName.compare("TTreeReaderValue<double>") ==0 ){ return BetaScope::SetInBranch<TTreeReaderValue,double>( branchName.c_str(), key.c_str()); }
  else if( typeName.compare("TTreeReaderValue<int>") ==0 ){ return BetaScope::SetInBranch<TTreeReaderValue,int>( branchName.c_str(), key.c_str()); }
