...
public:
    ...
    std::vector<data_type> get_v2()
    {
        return this->v2_;
    }

    data_type get_v1_value(int index)
    {
        return this->v1_.at(index);
    }
    data_type get_v2_value(int index)
    {
        return this->v2_.at(index);
    }

    void set_v1_value(int index, data_type value)
    {
        this->v1_.at(index) = value;
    }
    void set_v2_value(int index, data_type value)
    {
        this->v2_.at(index) = value;
    }

    void set_v1(std::vector<data_type> value)
    {
        this->v1_ = value;
    }
    void set_v2(std::vector<data_type> value)
    {
        this->v2_ = value;
    }
