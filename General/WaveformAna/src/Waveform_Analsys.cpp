...
)
{
    ...
    std::pair<double, double> tmaxFitHolder = WaveformAnalysis::Get_Fit_Tmax( waveform.get_v1(), waveform.get_v2(), pmaxHolder);
...
)
{
    ...
    waveform.fit_tmax_chi( WaveformAnalysis::Get_Fit_Tmax( waveform.get_v2(), waveform.get_v1(), pmaxHolder) );
    waveform.max_index( pmaxHolder.second);
