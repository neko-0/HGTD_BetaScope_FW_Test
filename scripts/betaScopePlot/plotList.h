...
class BookPlot
{
  ...
  public:
    ...
    void book_plot( int channel, std::string tag, std::string histo_name, std::string histo_title, std::string obs, std::string xTitle, std::string fitFunc, int binNum, double x_min, double x_max)
    {
      PlotList my_plot;
