...
if __name__ == "__main__":
    ...
    cml_parser.add_argument("-xtitle", dest="xtitle", nargs="?", default="", type=str, help="xtitle")
    cml_parser.add_argument("-ytitle", dest="ytitle", nargs="?", default="", type=str, help="ytitle")
