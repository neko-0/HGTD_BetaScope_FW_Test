...
def histoGaussFit( tfile_name, var_express, cuts, return_histo=False ):
    ...
    if return_histo:
        ...
        return {"histo":tdiff_histo, "sigma":sigma, "sigma_err":sigma_err, "mean":mean, "mean_err":mean_err}
    else:
        return {"sigma":sigma, "sigma_err":sigma_err, "mean":mean, "mean_err":mean_err}
